      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Analyse admissions performance across courses, regions and
              academic years.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-xl border bg-card p-5">
            ...
            {applicationChange !== null && compareYear && (
              <p
              ...
              >
                {applicationChange >= 0 ? "↑" : "↓"}{" "}
                {Math.abs(applicationChange).toFixed(1)}% vs {compareYear}
              </p>
            )}
          </div>
          ...
          <div className="rounded-xl border bg-card p-5">
            ...
            {admissionChange !== null && compareYear && (
              <p
                className={`mt-3 text-xs font-medium ${
                  admissionChange >= 0
                    ? "text-emerald-600"
              ...
              >
                {admissionChange >= 0 ? "↑" : "↓"}{" "}
                {Math.abs(admissionChange).toFixed(1)}% vs {compareYear}
              </p>
            )}
          </div>
          ...
          <div className="rounded-xl border bg-card p-5">
            ...
            {conversionChange !== null && compareYear && (
              <p
                className={`mt-3 text-xs font-medium ${
                  conversionChange >= 0
                    ? "text-emerald-600"
              ...
              >
                {conversionChange >= 0 ? "↑" : "↓"}{" "}
                {Math.abs(conversionChange).toFixed(1)}% vs {compareYear}
              </p>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
          <div className="rounded-xl border bg-card p-5">
            <div className="mb-5">
              <h2 className="font-semibold">Course-wise Admissions</h2>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="rounded-xl border bg-card p-5">
            <div className="mb-5">
              <h2 className="font-semibold">Region-wise Admissions</h2>
              <p className="text-sm text-muted-foreground">
        ...
        <div className="rounded-xl border bg-card p-5">
          <div className="mb-5">
            <h2 className="font-semibold">Year-over-Year Trend</h2>
            <p className="text-sm text-muted-foreground">
              Overall applications and admissions across academic years
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
            <div className="rounded-xl border bg-card p-5">
              <div className="mb-5 flex items-center gap-2">
                ...
                <div>
                  <h2 className="font-semibold">Rising Segments</h2>
                  <p className="text-sm text-muted-foreground">
            ...
            <div className="rounded-xl border bg-card p-5">
              <div className="mb-5 flex items-center gap-2">
                ...
                <div>
                  <h2 className="font-semibold">Declining Segments</h2>
                  <p className="text-sm text-muted-foreground">
