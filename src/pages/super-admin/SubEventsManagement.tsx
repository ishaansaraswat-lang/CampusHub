...
export default function SubEventsManagement() {
  ...
  const { data: subEvents, isLoading: subEventsLoading } = useAdminSubEvents(eventId || '');
          ...
          <Dialog open={isDialogOpen} onOpenChange={(open) => { setIsDialogOpen(open); if (!open) resetForm(); }}>
            ...
            <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a competition, workshop, or activity for this event
                </DialogDescription>
              </DialogHeader>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData((prev) => ({ ...prev, is_team_event: checked }))}
                  />
                ...
                <DialogFooter>
                  ...
                  <Button type="submit" disabled={isPending}>
                    {isPending ? (
                      ...
                      editingSubEvent ? 'Update Activity' : 'Add Activity'
                    )}
                  </Button>
                </DialogFooter>
              </form>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => openEditDialog(subEvent)}
                    >
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will permanently delete "{subEvent.name}" and all its registrations.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
                          <AlertDialogAction
                            onClick={() => deleteSubEvent.mutate({ id: subEvent.id, eventId: eventId! })}
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                Add competitions, workshops, and activities to this event
              </p>
