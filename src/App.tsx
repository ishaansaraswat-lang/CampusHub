...
import EventAdminAttendance from "./pages/event-admin/Attendance";
...
<Route path="/admin/events/:eventId/attendance/analytics" element={<ProtectedRoute allowedRoles={['event_admin','super_admin']}><AttendanceAnalytics /></ProtectedRoute>} />
<Route
